...
| Localization | PARTIALLY_IMPLEMENTED | `frontend/src/i18n/*`; `frontend/src/styles/index.css`; `frontend/src/components/AppShell.tsx`; `docs/I18N.md` | High | Frontend i18n supports English/Persian and RTL. Backend/content localization is limited to existing locale query fields and not a full translation system. |
