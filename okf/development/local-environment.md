...
| Install frontend dependencies | `frontend/` | `npm ci` | Node and npm | `node_modules` is recreated exactly from the lockfile | npm nonzero exit | `frontend/package.json`, `frontend/package-lock.json` | Dependency lifecycle scripts execute with developer privileges |
