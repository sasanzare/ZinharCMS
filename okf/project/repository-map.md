...
| .github/workflows/ | CI definitions | GitHub Actions; tooling | Shared release-version checks, backend format/Clippy/tests, and frontend lockfile/audit/lint/typecheck/tests/build | backend-ci.yml and frontend-ci.yml | Phase 10 |
...
| Build configuration | ../../frontend/package.json; ../../frontend/vite.config.ts; ../../frontend/tsconfig.json; ../../frontend/tsconfig.app.json; ../../frontend/tsconfig.node.json; ../../frontend/eslint.config.js; ../../frontend/vitest.config.ts; ../../frontend/Dockerfile; ../../frontend/Dockerfile.prod; ../../frontend/nginx.conf | CI and Dockerfiles use Node 24 with lockfile-enforced `npm ci` |
